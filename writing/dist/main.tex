...
\NormalTok{\{}
   \DataTypeTok{people}\NormalTok{: [}
      ...
      \NormalTok{\{}\DataTypeTok{townOrCity}\NormalTok{:}\StringTok{'Walter'}\NormalTok{, }\DataTypeTok{name}\NormalTok{: }\StringTok{'Sally'}\NormalTok{\}}
   \NormalTok{]}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
arrived Walter would find a different handling than John or Jack.
Because the serialisation will contain items which are written to follow
an indeterminate order it will be important to ensure that, despite the
...
applications were built using abstractions over the underlying browser
differences they could be written purposefully and were able to express
more complex ideas without becoming incomprehensible.
...
older browsers through Javascript. Websockets are a promising technology
...
\subsection{Componentisation of the project}
...
Javascript. Additionally, the http adaptor\footnote{\href{https://github.com/substack/http-browserify}{Https://github.com/substack/http-browserify}.}
...
needed. See \hyperref[header_functional]{functional.js} (Appendix
...
\hyperref[header_lists]{lists.js} (Appendix p.\pageref{src_lists})
...
express the clause patterns. Each regular expressions starts with
...
browser support\footnote{\href{https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular\textbackslash{}_Expressions}{Https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular\textbackslash{}\_Expressions}.}.
...
a more repeatable results than browsers which could be performing any
...
The code below is shortened by using the get-json\footnote{\href{https://npmjs.org/package/get-json}{Https://npmjs.org/package/get-json}.}
...
The file \texttt{oboe.performance.spec.js}\footnote{\href{https://github.com/jimhigson/oboe.js/blob/master/test/specs/oboe.performance.spec.js}{Tests/spec/oboe.performance.spec.js}.}
...
created for every matching node, and will be predominantly ignored. will
be predominantly ignored. Under a functional language these could be
lazily evaluated without requiring any special effort by the application
...
should be given to optimisation under Firefox, this project meets all if
...
\hyperdef{}{header_functional}{\subsection{functional.js}\label{header_functional}}
...
\hyperdef{}{header_lists}{\subsection{lists.js}\label{header_lists}}
