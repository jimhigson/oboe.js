...
it already did better, not so that it can stay still. Following an
...
\subsection{The JsonPath and XPath selector languages}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{<!-- as JSON perhaps? -->}
\KeywordTok{<people>}
   \KeywordTok{<person>}
      \KeywordTok{<name>}\NormalTok{...}\KeywordTok{</name>}   
      \KeywordTok{<town>}\NormalTok{Bond}\KeywordTok{</town>}
   \KeywordTok{</person>}
\KeywordTok{</people>}
\end{Highlighting}
\end{Shaded}
