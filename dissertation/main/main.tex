...
\KeywordTok{function} \FunctionTok{instanceController}\NormalTok{(  emit, on, un, }
   ...
   \KeywordTok{var} \NormalTok{oboeApi, rootNode, responseHeaders,}
       \NormalTok{addDoneListener = }\FunctionTok{partialComplete}\NormalTok{(}
                              \NormalTok{addNodeOrPathListenerApi, }
                              \NormalTok{NODE_FOUND, }
                              \StringTok{'!'}\NormalTok{);}

   \CommentTok{// when the root node is found grab a reference to it for later      }
   ...
   \FunctionTok{on}\NormalTok{(HTTP_START, }\KeywordTok{function}\NormalTok{(_statusCode, headers) \{}
      \NormalTok{responseHeaders = headers;}
   \NormalTok{\});}
   ...
   \KeywordTok{function} \FunctionTok{addNodeOrPathListenerApi}\NormalTok{( eventId, jsonPathOrListenerMap, callback )\{}
      ...
      \KeywordTok{if}\NormalTok{( }\FunctionTok{isString}\NormalTok{(jsonPathOrListenerMap) ) \{}
         \FunctionTok{addPathOrNodeCallback}\NormalTok{( }
            ...
            \FunctionTok{protectedCallback}\NormalTok{(callback)}
         \NormalTok{);}
...
\CommentTok{    */}       
   \KeywordTok{function} \FunctionTok{addListener}\NormalTok{( eventId, listener )\{}
      ...
      \KeywordTok{switch}\NormalTok{(eventId) \{}
         \KeywordTok{case} \DataTypeTok{NODE_FOUND}\NormalTok{:}
         \KeywordTok{case} \DataTypeTok{PATH_FOUND}\NormalTok{:}
            \FunctionTok{apply}\NormalTok{(arguments, addNodeOrPathListenerApi);}
            \KeywordTok{break}\NormalTok{;}
            
         \KeywordTok{case} \StringTok{'done'}\NormalTok{:}
            \FunctionTok{addDoneListener}\NormalTok{(listener);         }
            \KeywordTok{break}\NormalTok{;}
            
         \KeywordTok{default}\NormalTok{:}
            \CommentTok{// for cases: 'fail', 'start'}
...
\CommentTok{    */}
   \KeywordTok{return} \NormalTok{oboeApi = \{}
      ...
      \DataTypeTok{start }\NormalTok{:  }\FunctionTok{partialComplete}\NormalTok{(on, HTTP_START),}
      ...
      \DataTypeTok{header}\NormalTok{:  }\KeywordTok{function}\NormalTok{(name) \{}
                  \KeywordTok{return} \NormalTok{name ? responseHeaders && responseHeaders[name] }
                              \NormalTok{: responseHeaders}
                              \NormalTok{;}
               \NormalTok{\},}
