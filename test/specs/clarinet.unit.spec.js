...
import { SAX_KEY, SAX_VALUE_OPEN, SAX_VALUE_CLOSE, FAIL_EVENT, STREAM_DATA, STREAM_END } from '../../src/events'
import { clarinet } from '../../src/libs/clarinet'
import { prettyPrintEvent } from '../libs/prettyPrintEvents'
...
var docs =
  {
    ...
    string_invalid_escape:
      {
        text:
          '["and you can\'t escape thi\s"]', // eslint-disable-line no-useless-escape
        events:
          [[SAX_VALUE_OPEN, []],
...
describe('clarinet', function () {
  ...
  for (var key in docs) {
    ...
    describe('case ' + key, function () {
      var bus = pubSub()
      var blackBoxRecording = eventBlackBox(bus, expectedEventNames)
